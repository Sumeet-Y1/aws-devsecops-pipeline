...
* The original package name 'com.devops.aws-devsecops-pipeline' is invalid and this project uses 'com.devops.aws_devsecops_pipeline' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/3.5.15/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
